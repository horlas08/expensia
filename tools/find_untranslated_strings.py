...
EXCLUDE_DIRS = {'build', 'assets', 'test', 'windows', 'macos', 'linux', 'web', 'android', 'ios', '.dart_tool', '.idea', '.git', 'localization'}
EXCLUDE_KEYWORDS = ['assets/', 'asset/', 'http://', 'https://', 'services/', 'service/', 'model/', 'models/']
